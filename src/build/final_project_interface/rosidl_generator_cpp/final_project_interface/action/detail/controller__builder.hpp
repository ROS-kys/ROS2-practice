...
class Init_Controller_Result_end_point
{
public:
  Init_Controller_Result_end_point()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::final_project_interface::action::Controller_Result end_point(::final_project_interface::action::Controller_Result::_end_point_type arg)
  {
...
{
  return final_project_interface::action::builder::Init_Controller_Result_end_point();
}
...
class Init_Controller_Feedback_now_point
{
public:
  Init_Controller_Feedback_now_point()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::final_project_interface::action::Controller_Feedback now_point(::final_project_interface::action::Controller_Feedback::_now_point_type arg)
  {
...
{
  return final_project_interface::action::builder::Init_Controller_Feedback_now_point();
}
